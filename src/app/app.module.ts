...
const appRoutes: Routes = [
  ...
  { path:'dashboard/viewrole' ,canActivate:[AuthGuard],  component: ViewroleComponent},
 ...
 { path: 'dashboard/assignrole', canActivate:[AuthGuard], component: AssignroleComponent},
